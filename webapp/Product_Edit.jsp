...
<%String message = (String) request.getAttribute("msg");%>
	...
	<div class="div1">
		...
		<div class="div">
			...
			<div class="div5">
				<a href="product.html" class="whi">AddProduct</a>
			</div>
			<div class="div5">
				<a href="viewProducts2" class="whi">ViewAllProducts</a>
			</div>
			<div class="div5">
				<%
	...
	if (al.size() == 0) {
		...
		while (it.hasNext()) {
			...
			out.println(pb.getpCode() + "&nbsp&nbsp" + pb.getpName() + "&nbsp&nbsp<h3><del>" + pb.getMprice()
			+ "</del></h3>&nbsp&nbsp<h2><p> Rs : " + +pb.getpPrice() + "</h2></p>&nbsp&nbsp<p> Only " + pb.getpQty()
			+ " Product Left <br> Please Add More Product</p>&nbsp&nbsp" + "<a href='editProduct2?pcode="
			+ pb.getpCode() + "'><div class='cen'><button class='buy-button'>Edit</button></div></a>" + "&nbsp&nbsp"
			+ "<a href='deleteProduct1?pcode=" + pb.getpCode()
			+ "'><div class='cen'><button class='buy-button'>Delete</button></div></a>" + "");
			out.println("</div>");
			out.println("</div>");
		}
	}
