...
<html>
<head>
<title>String Comparison Result</title>
...
<div class="div1">
	...
	if (userInput != null && userInput.equals(captcha)) {
		request.setAttribute("msg", "Orderd Done Successfully....!");
		RequestDispatcher dispatcher = request.getRequestDispatcher("Payment_Done.jsp");
