...
<body>
    ...
    <%
	ProductBean pb = (ProductBean) request.getAttribute("pb1");
	%>
<div class = "box">
<span class = "borderLine"></span>
	<form action="updateProduct1" method="post" id="myForm">
		<h2>Update Product</h2>
		<div class = "inputBox">
			<input type ="text"  name="price" id="price" value=<%=pb.getpPrice()%>>
		...
		<div class = "inputBox">
			<input type ="text"  name="qty" id="qty" value=<%=pb.getpQty()%>>
		...
		<div class = "links">
			...
			<a href="AdminViewAllProducts.jsp">Back</a>			
		</div>
		<input type="submit" value="Update" class="sum">
	</form>
</div>
<script>
  document.getElementById('myForm').addEventListener('submit', function(event) {
    const numberInput = document.getElementById('qty').value;
...
<script>
  document.getElementById('myForm').addEventListener('submit', function(event) {
    ...
    if (!isPositiveNumber(numberInput)) {
      document.getElementById('error1').innerText = '*Please enter a positive Price.';
      event.preventDefault(); 
    }
  });
