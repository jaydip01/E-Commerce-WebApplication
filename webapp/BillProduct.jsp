...
<div class="div1">
	...
	<form action="payment" method="post">
		Code:<br> <input type="text" name="code" readonly value=<%=pb.getpCode()%>><br><br>
		Name:<br><input type="text" name="name" readonly value=<%=pb.getpName()%>><br><br>
	    Reqqty:<br> <input type="text" name="reqqty" readonly value=<%=qty%>> <br> <br>
	    TotalAmout:<br><input type="text" name="totpayment" readonly value=<%=Payment%>> <br> <br>
	    <input type="hidden" name="cosname"  value=<%=ub.getfName()%>>
