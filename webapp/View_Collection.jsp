...
<head>
<meta charset="UTF-8">
<title>View Collection Before</title>
...
<%
	...
	out.println("<table >");
	out.println("<tr> <th class='inth'>Customer Name</th><th class='inth'>Product Name</th> <th class='inth'>Product Price</th> <th class='inth'>Product qty</th><th class='inth'>Total Price</th> </tr>");
	out.println("");
	if (al.size() == 0) {
		...
		while (it.hasNext()) {
			...
			out.println("<th>" +pb.getComNmae()+ "</th><th>" + pb.getpName() + "</th><th>"+ 
                  pb.getpPrice() + "</th><th>" + 
	...
	<div class="deleteAll">
	<form action="deletecolection" method="get">
	 <input type="submit" class="btn" value="Delete All Orders" name="su">
	</form>
	</div>
