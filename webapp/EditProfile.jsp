...
<body>
 ...
 UserBean ub =
 (UserBean)application.getAttribute("ubean2");
...
<span class = "borderLine"></span>
	<form action="update1" method="post">
		...
		<div class = "inputBox">
			<input type ="text"  name="addr" value=<%=ub.getAddr() %> required>
			<span>Address</span>
			<i></i>
		</div>
		
		<div class = "inputBox">
			<input type="email"  name="mid" value=<%=ub.getmId() %> required>
			<span>Email</span>
			<i></i>
		</div>
		<div class = "inputBox">
			<input type ="text"  name="phno" value=<%=ub.getPhNo() %> required>
			<span>Phone no</span>
			<i></i>
		</div>
