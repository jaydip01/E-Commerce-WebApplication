...
<body>
	...
	if (al.size() == 0) {
		...
		while (it.hasNext()) {
			...
			+ pb.getMprice() + "</h3></del>&nbsp&nbsp" + "<h2><p> Rs : " + pb.getpPrice() + "&nbsp&nbsp"
			+ "</h2></p><p> Only " + pb.getpQty() + "&nbsp&nbsp Qty <br> Hurry Upp..</p>" + ""
			+ "<a href='buyProduct?pcode=" + pb.getpCode()
			+ "'><div class='cen'><button class='buy-button'>Buy</button></div></a>");
