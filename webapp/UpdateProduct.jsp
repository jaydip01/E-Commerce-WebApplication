...
<body>
<%
AdminBean ab =(AdminBean)session.getAttribute("abean1");
...
<div class="div1">
		...
		<div class="div">
			...
			<div class="div5"><%out.println(ab.getfName()+"<br>"); %></div>
			<div class="div5"><a href="product.html">AddProduct</a></div>
			<div class="div5"><a href="viewProducts">ViewAllProducts</a></div>
		</div>
	</div>
